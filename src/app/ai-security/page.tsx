      ...
      <div className="container mx-auto px-4 py-16">
        ...
        >
          <div className="bg-vscode-sidebar border border-vscode-border rounded-sm p-6 text-center">
            <div className="text-3xl font-bold text-vscode-type mb-2">1000+</div>
            <div className="text-sm text-gray-400 font-mono">Test Vectors</div>
          </div>
          
          <div className="bg-vscode-sidebar border border-vscode-border rounded-sm p-6 text-center">
            <div className="text-3xl font-bold text-vscode-type mb-2">99.9%</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-vscode-sidebar border border-vscode-border rounded-sm p-6">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h3 className="text-lg font-bold text-vscode-type font-mono">LLM Security Testing</h3>
              </div>
            ...
            <div className="bg-vscode-sidebar border border-vscode-border rounded-sm p-6">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h3 className="text-lg font-bold text-vscode-type font-mono">Prompt Injection Detection</h3>
              </div>
              <p className="text-gray-300 text-sm leading-relaxed mb-4">
            ...
            <div className="bg-vscode-sidebar border border-vscode-border rounded-sm p-6">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h3 className="text-lg font-bold text-vscode-type font-mono">Jailbreaking Detection</h3>
              </div>
              <p className="text-gray-300 text-sm leading-relaxed mb-4">
            ...
            <div className="bg-vscode-sidebar border border-vscode-border rounded-sm p-6">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h3 className="text-lg font-bold text-vscode-type font-mono">Adversarial Attack Detection</h3>
              </div>
              <p className="text-gray-300 text-sm leading-relaxed mb-4">
        ...
        >
          <div className="bg-vscode-sidebar border border-vscode-border rounded-sm p-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Button size="lg" variant="outline" className="border-tactical-600 text-tactical-400 hover:bg-tactical-900/30 font-mono uppercase" onClick={() => window.location.href = '/contact'}>
                Request Demo
              </Button>
            </div>
          </div>
